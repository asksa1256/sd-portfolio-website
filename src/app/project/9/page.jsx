    ...
    <PageWrapper>
      <section className="projectDetail">
        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              ...
              ´천지창조´를 인용했습니다. 작품 이외의 영역은 검정색과 흰색 위주로
              사용하여 전체적으로 너무 복잡해보이지 않도록 했고, 메인 페이지의
              경우에는 스크롤 인터랙션에 따라 각 섹션들이 부드럽게 이어지는
              애니메이션에 비중을 두었습니다.
            </p>
            <p className="phrase">
        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              회사에서 Vue.js 프레임워크를 사용하여 SPA(Single Page Application)
              형식의 그룹웨어를 만들어보고 나서 그 형식에 매력을 느껴 개인
              프로젝트에도 적용해보고 싶었고, Vue.js보다 많이 쓰이는 React.js로
              제작하려다가 React사에서 지원하는 Next.js에 관심이 생겼습니다.
            </p>
            <p className="phrase">
              Next.js는 라우터 구조상 SPA처럼 사용하려면 Next.js에서 기본적으로
              제공되는 방식과 다르게 코딩해야 했지만, 페이지 전환 시 깜빡임이
              거의 없다는 점이 SPA와 매우 유사해보이고 라우팅은 리액트보다 훨씬
              간편해서 새로운 환경임에도 적응을 빨리 할 수 있었습니다.
            </p>
            <p className="phrase">
