        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              ...
              시안이 있었지만 모두 중간에 멈춘 상태였고 디자인부터 마무리를 해야
              하는데 당시에 웹 디자이너도 없던 상황이었습니다.
            </p>
            <p className="phrase">
              비록 웹 디자이너가 없었지만 어느 정도 만들어진 시안이 있었으므로,
              컨셉을 유지하는 것에 집중해서 클라이언트의 확인을 받아가며 디자인
              작업을 끝낸 뒤 퍼블리싱을 진행했습니다.
            </p>
          </m.div>
        </m.div>
        <m.div
