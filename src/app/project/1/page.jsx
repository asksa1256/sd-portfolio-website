              ...
              <m.div variants={Item} className="right">
                ...
                >
                  <m.p variants={Item} className="phrase">
                    ...
                    체험판이거나 유료라는 단점이 있었고, 테라에너지의 특성에
                    맞는 그룹웨어를 찾아서 제한적으로 사용하기 보다는 직접
                    맞춤형 그룹웨어를 만들자는 의견에 따라 그룹웨어 시스템을
                    자체 개발하여 도입했습니다.
                  </m.p>
                  <m.p variants={Item} className="phrase">
                    개발 언어로 Vue.js, TypeScript를 사용하여 싱글 페이지
                    어플리케이션 형식으로 만들었으며 깔끔하고 편리한 UI를
                    접목시켜 회사 내부에서 쉽고 빠르게 사용할 수 있는 무료
                    그룹웨어를 개발한 결과, 전반적인 업무를 한 곳에서 다룰 수
                    있어 업무 효율성이 많이 개선되고 비용 부담을 줄이면서도
                    편리한 업무 환경을 구축할 수 있게 되었습니다.
                  </m.p>
                </m.div>
              </m.div>
            </m.div>
          ...
          >
            ...
            <m.div variants={Item} className="right">
              ...
              <p className="phrase">
                ...
                삼는 것도 도움이 되었습니다. 그룹웨어에 테마 변경 기능을 추가할
                때 UI 컴포넌트 및 클래스를 재사용하기 수월하도록 스타일 가이드를
                작성해본 것도 좋은 경험이었습니다.
              </p>
            </m.div>
          </m.div>
          ...
          >
            ...
            <m.div variants={Item} className="right">
              ...
              <p className="phrase">
                ...
                기능을 추가하는 등 컴포넌트 구조의 이점들을 파악할 수 있었던
                좋은 경험이었습니다.
              </p>
            </m.div>
          </m.div>
