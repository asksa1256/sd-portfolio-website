    ...
    <PageWrapper>
      <section className="projectDetail">
            ...
            <m.div variants={Item} className="right">
              ...
              >
                <m.p variants={Item} className="phrase">
                  좋은 그룹웨어들이 시장에 이미 많이 배포되어 있지만 모두
                  체험판이거나 유료라는 단점이 있었고, 테라에너지의 특성에 맞는
                  그룹웨어를 찾아서 제한적으로 사용하기 보다는 직접 맞춤형
                  그룹웨어를 만들자는 의견에 따라 그룹웨어 시스템을 자체
                  개발하여 도입했습니다.
                </m.p>
                <m.p variants={Item} className="phrase">
                  개발 언어로 Vue.js, TypeScript를 사용하여 싱글 페이지
                  어플리케이션 형식으로 만들었으며 깔끔하고 편리한 UI를 접목시켜
                  회사 내부에서 쉽고 빠르게 사용할 수 있는 무료 그룹웨어를
                  개발한 결과, 전반적인 업무를 한 곳에서 다룰 수 있어 업무
                  효율성이 많이 개선되고 비용 부담을 줄이면서도 편리한 업무
                  환경을 구축할 수 있게 되었습니다.
                </m.p>
              </m.div>
            </m.div>
        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              프로젝트를 처음 시작했을 때, 디자이너가 따로 배정되지 않아서
              프로젝트 팀의 퍼블리셔였던 제가 디자인도 함께 해야 했습니다.
              혼자서 취미 삼아 디자인을 해본 적은 있지만 요청에 의해 시작한
              디자인은 처음이라서 어디서부터 시작해야 될 지 막막했습니다.
            </p>
            <p className="phrase">
              다행히도 타 직무의 웹 디자이너와 상의하여 피드백을 자주 받아서
              그룹웨어 디자인을 마칠 수 있었고, 잘 만들어진 예시들을 레퍼런스
              삼는 것도 도움이 되었습니다. 그룹웨어에 테마 변경 기능을 추가할 때
              UI 컴포넌트 및 클래스를 재사용하기 수월하도록 스타일 가이드를
              작성해본 것도 좋은 경험이었습니다.
            </p>
          </m.div>
        </m.div>
        <m.div
          ...
          whileInView="show"
        >
          <Image src="/images/hi5-2.png" alt="그룹웨어 Hi5 XD 작업 화면" fill />
        </m.div>
        <m.div
          className="detailContent"
          variants={Container}
        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              Vue.js는 작업 환경 설정부터 문법까지 저의 기존 작업 방식(HTML5,
              CSS3, JavaScript 또는 JQuery를 이용한 방식)과 많이 달랐으며
              컴포넌트 위주의 화면 개발에 대한 사전 지식이 필요했습니다.
            </p>
            <p className="phrase">
              Vue.js에서의 컴포넌트 작동 원리를 이해하는 데에 시간이 조금
              걸렸지만 동료들과 협업 해보면서 혼자 퍼블리싱 해도 크게 무리가
              없을 정도로 적응할 수 있었고, 컴포넌트 안에 다른 컴포넌트를 넣어
              기능을 추가하는 등 컴포넌트 구조의 이점들을 파악할 수 있었던 좋은
              경험이었습니다.
            </p>
          </m.div>
        </m.div>
