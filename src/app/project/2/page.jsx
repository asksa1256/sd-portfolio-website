      ...
      <section className="projectDetail">
          ...
          <m.div variants={Item} className="detailList">
            ...
            <m.div variants={Item} className="right">
              ...
              >
                ...
                <m.p variants={Item} className="phrase">
                  또한 디자인이 정적인 디자인에서 트렌디하게 바뀌었기 때문에 그
                  느낌을 살리기 위해 인터랙션 요소를 너무 과하지 않은 선에서
                  적용했습니다. 사이트의 주 사용자가 4~50대 남성이기 때문에
                  애니메이션이 많으면 오히려 가독성과 사용성이 낮아질 것을
                  고려했습니다.
                </m.p>
              </m.div>
            </m.div>
        ...
        >
          <m.div variants={Item} className="left">
            <h5 className="contentSubTitle">CMS(Content Management System)</h5>
          </m.div>
          <m.div variants={Item} className="right">
            <p className="phrase">
              동일이엔티 홈페이지는 그누보드로 제작되어 있었습니다. 그 상태에서
              디자인 리뉴얼을 요청받았는데, 이전에 무료 CMS인 그누보드로 사이트
              만드는 연습을 해보긴 했지만 실전에서는 처음이었습니다. 최대한 빨리
              퍼블리싱 해달라는 요청에 CMS 솔루션 없이 HTML부터 만들 때와
              비슷하게 반응형을 포함해서 10일로 작업 기간을 잡았지만, CMS의 파일
              구조는 생각보다 더 복잡했으며 기존 코드에서 수정을 해야 되는
              부분도 있어서 코드를 이해하는 것에도 시간이 필요했습니다.
            </p>
            <p className="phrase">
              항상 기한 내에 작업을 마쳐왔지만 이번에는 그누보드의 복잡한 구조상
              시간이 더 필요하다 판단해서 작업 셋째 날에 컨펌 담당자한테 기한을
              4~5일 늘려달라고 요청했습니다. 마감까지 시간이 꽤 남은 시점에서
              미리 말씀드렸기 때문에 별 문제 없이 클라이언트와도 상의하여 작업
              기간을 늘리고, 기한에 맞춰서 작업을 성공적으로 마쳤습니다.
            </p>
          </m.div>
        </m.div>
        <m.div
