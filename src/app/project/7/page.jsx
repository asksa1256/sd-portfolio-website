            ...
            <m.div variants={Item} className="right">
              ...
              >
                <m.p variants={Item} className="phrase">
                  ...
                  실내 조명의 점소등 상태 및 이상 유무를 IoT 통신으로 확인할 수
                  있는 시스템입니다. 본 제품은 Flutter로 개발되었으며 상용화를
                  목표로 제작된 소개 페이지가 있습니다.
                </m.p>
              </m.div>
            </m.div>
          </m.div>
        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              ...
              하던 방식과 똑같이 퍼블리싱 하면 되어서 어려움이 없었지만, Selene
              어플리케이션은 iOS와 Android의 호환성을 고려하여 Flutter로
              개발하게 되었기 때문에 네이티브 앱을 퍼블리싱하기 위해 Flutter와
              Dart 관련 지식이 요구되었습니다.
            </p>
            <p className="phrase">
              Flutter로 어떤 앱을 만들 수 있는지, Flutter로 개발했을 때의 이점은
              무엇인지 이해하며 강의나 간단한 앱 클론 코딩으로 감을 익혔습니다.
              다만 JavaScript에 대한 이해도가 높지 않을 때 작업했기 때문에
              데이터 연동이 필요한 부분이나 복잡한 구현은 프론트엔드 개발자에
              전달해서 작업 시간이 지연되지 않도록 했습니다.
            </p>
          </m.div>
        </m.div>
