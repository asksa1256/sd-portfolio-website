              ...
              <m.div variants={Item} className="right">
                ...
                >
                  <m.p variants={Item} className="phrase">
                    카카오더는 테라에너지에서 기획한 카페 스마트오더
                    서비스입니다. 프렌차이즈 카페보다는 개인 소상공인 카페
                    점주들을 주 사용자로 두고 개발된 솔루션으로, 온라인
                    주문/결제, 매장 분석/관리 등의 기능을 어플 형식으로 점주에게
                    고정비 및 광고비 없이 제공하여 자금이 넉넉하지 않은 개인
                    소상공인도 고품질의 편리한 사이렌오더 서비스를 이용할 수
                    있게 해주는 것이 목표입니다.
                  </m.p>
                </m.div>
              </m.div>
