            ...
            <m.div variants={Item} className="right">
              ...
              >
                <m.p variants={Item} className="phrase">
                  비스무스는 비즈니스 니즈에 따라 시각화된 데이터를 보고 조건에
                  따라 검색할 수 있는 대시보드 솔루션이며, 데이터 시각화를 위해
                  사용된 차트는 Apache ECharts 라이브러리로 제작했습니다.
                  디자인은 따로 정해진 시안 없이 그룹웨어 Hi5와 동일한 디자인
                  컨셉으로 진행하기로 해서 디자인과 퍼블리싱을 모두
                  담당했습니다.
                </m.p>
              </m.div>
            </m.div>
        ...
        >
          ...
          <m.div variants={Item} className="right">
            <p className="phrase">
              ...
              하드코딩으로 작업하면 개발팀에 전달했을 때 데이터 연결도 어려울 것
              같았습니다. 그리고 데이터가 있어야 차트를 표현할 수 있는데
            ...
            <p className="phrase">
              ...
              비스무스가 제공할 데이터에 맞춰 다양한 시각화를 할 수 있었습니다.
              퍼블리싱 작업 예상 기간도 반응형 포함 10일에서 7일로 단축되었으며
              실 작업 기간은 5일이 소요되었고, 실데이터가 없던 문제도 가데이터가
              담긴 json 파일을 만들어서 차트 코드에 연동하면 수치에 맞게 표현이
              되어서 동적인 대시보드를 쉽게 만들 수 있었습니다.
            </p>
          </m.div>
        </m.div>
        <div className="imgContainer">
          <div className="imgWrap">
            <m.figure
              ...
              viewport={{ once: true }}
            >
              <Image src="/images/bis-2.jpg" alt="" width="776" height="434" />
            </m.figure>
        ...
        <div className="imgContainer">
          <div className="imgWrap">
            <m.figure
              ...
              viewport={{ once: true }}
            >
              <Image src="/images/bis-3.jpg" alt="" width="1232" height="846" />
            </m.figure>
